...
Developed, mentored, and led a small team of junior data scientists through the rocky shoals of developing those products from spatial data. We applied sophisticated machine learning to very large sensor datasets (100MM rows daily) to learn behavioral patterns from the way people interacted with space. (<span id="recode">ensemble learning: random forests, gradient boosting; cluster analysis</span>)
...
As a research assistant, I did a lot of the analytic heavy lifting to wrangle data, fit and interpret models (<span id="recode">log-linear, non-linear, non-parametric models</span>), and visualize the results in support of a multi-year NSF-funded research project on US interstate migration patterns of the foreign born (see papers below).
